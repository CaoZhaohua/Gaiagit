...
#import "TeethManagerViewController.h"
#import "TeethTestViewController.h"
#import "XCQ_tabbar.h"
...
-(instancetype)initWithNomarImageArr:(NSArray *)nomarImageArr andSelectImageArr:(NSArray *)selectImageArr andtitleArr:(NSArray *)titleArr
{
    ...
    if (self) {
        ...
        TeethTestViewController *twoVC = [[TeethTestViewController alloc]init];
        TeethManagerViewController *threeVC= [[TeethManagerViewController alloc]init];
        MineViewController *fourVC = [[MineViewController alloc]init];
        oneVC.view.backgroundColor = XCQRandColor ;
        twoVC.view.backgroundColor = XCQRandColor ;
        threeVC.view.backgroundColor = XCQRandColor ;
        fourVC.view.backgroundColor  = XCQRandColor ;

        
        NSArray *VCArr =@[oneVC,twoVC,threeVC,fourVC] ;
